...
<a href="https://api.whatsapp.com/send?phone=919423979339&text=Hi%20,%20I%20saw%20your%20Project%20named%20as%20RedCock%20Farm.%20I%20need%20your%20help%20for%20the%20same." class="float" target="_blank">
<i class="fa fa-whatsapp my-float"></i>
 ...
 <strong style="color: red; background-color: white; margin-left: 100px;">
                        Alert : Welcome to Red cock farms!</strong>
            ...
            <div class="col-md-6 stretch-card grid-margin">
              ...
              <div class="col-md-6">
                <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                  ...
                  $sql="SELECT * from  tblcompany where developer='Assibi_luv'";
                  $query = $dbh -> prepare($sql);
                  ...
                  if($query->rowCount() > 0)
                  {
                    ...
                    {  
                      ...
                      { 
                        ?>
                        <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar" style="height: 60px; width: 60px;" src="assets/img/avatars/" alt=""></a>
                      <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img style="height: 30px; width: 30px;" src="assets/img/avatars/" alt="logo" /></a>
                        <?php 
                      } else { ?>
